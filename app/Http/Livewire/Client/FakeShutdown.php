...
class FakeShutdown extends Component
{
    public $device_id;
    public $device_token;
    ...
    public function fakeShutdownStart()
    {
        $this->sendNotification('fake_shutdown_start');
    }

    public function fakeShutdownStop()
    {
        $this->sendNotification('fake_shutdown_stop');
    }
    

    public function render()
    {
        return view('livewire.client.fake-shutdown');
    }
}
