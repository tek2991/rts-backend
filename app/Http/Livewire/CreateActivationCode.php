...
class CreateActivationCode extends Component
{
    public $cgst;
    public $sgst;
    ...
    {
        $this->validate([
            'state.code' => 'required|string|unique:activation_codes,code',
        ...
        // Save to session
        session()->flash('flash.banner', 'Activation code created successfully: ' . $this->state['code']);
    ...
    {
        return view('livewire.create-activation-code');
    }
}
