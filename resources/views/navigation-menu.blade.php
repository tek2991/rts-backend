                    ...
                    @hasanyrole('administrator|manager')
                        ...
                        <x-nav-dropdown-wrapper id="user_management_dropdownNavbar">
                            ...
                            @can('viewAny', App\Models\Coupon::class)
                                <x-nav-dropdown-item href="{{ route('coupon.index') }}" :active="request()->routeIs('coupon.*')">
                                    {{ __('Coupons') }}
                                </x-nav-dropdown-item>
                            @endcan

                            {{-- Activation Codes --}}
                            @can('viewAny', App\Models\ActivationCode::class)
                                <x-nav-dropdown-item href="{{ route('activation-code.index') }}" :active="request()->routeIs('activation-code.*')">
                                    {{ __('Activation Codes') }}
                                </x-nav-dropdown-item>
                            @endcan
