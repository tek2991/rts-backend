<div class="max-w-7xl mx-auto">
    <div class="flex items-end justify-between">
        <div class="flex items-end justify-end mt-3 px-2 sm:p-0">
            <button wire:click="loadRecordings"
            ...
            <div>
                <div class="border-2 p-1 rounded-md">
                    ...
                    <div class="flex justify-end">
                        <button
                            wire:click="$emit('openModal', 'confirm-delete-modal', {{ json_encode(['route' => 'client.voice-recorder.destroy', 'model_id' => $recording->id, 'model_name' => 'Recording', 'action' => 'delete']) }})"
                    ...
                    <audio controls class="w-full">
                        <source src="{{ $recording->s3Url() }}" type="audio/mpeg">
