        ...
        <div class="flex items-center justify-between">
            ...
            <div class="ml-6">
                <button type="button" wire:click="refreshDeviceStatus"
                    class="px-2 py-1.5 text-xs font-bold text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
