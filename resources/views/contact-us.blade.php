<x-guest-layout>
    @livewireStyles
    <section class="bg-blue-50 h-screen dark:bg-slate-800" id="contact">
                ...
                <div class="grid md:grid-cols-2">
                    <div class="h-full pr-6">
                        <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                            You can contact us with anything related to our Products. We'll get in touch with you as soon
                            as possible. <br>
                            <br>
                        </p>
                        <ul class="mb-6 md:mb-0">
                            <li class="flex">
                                ...
                                <div class="ml-4 mb-4">
                                    ...
                                    <p class="text-gray-600 dark:text-slate-400">HATKHOWAPARA,AZARA GUWAHATI,</p>
                                    <p class="text-gray-600 dark:text-slate-400">KAMALPUR BLOCK AZARA</p>
                                    <p class="text-gray-600 dark:text-slate-400">KAMRUP-781017</p>
                                </div>
                            </li>
                            <li class="flex">
                                <div
                                ...
                                <div class="ml-4 mb-4">
                                    ...
                                    <p class="text-gray-600 dark:text-slate-400">Mobile: 7002529862/ 8822927622</p>
                                    <p class="text-gray-600 dark:text-slate-400">Mail: admin@privatech.in</p>
                                    <p class="text-gray-600 dark:text-slate-400">Alternate Mail: privatech0000@gmail.com</p>
                                </div>
                            </li>
                            <li class="flex">
                                <div
                                ...
                                <div class="ml-4 mb-4">
                                    <h3 class="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Working
                                        hours</h3>
                                    <p class="text-gray-600 dark:text-slate-400">Monday - Friday: 09:00 - 17:00</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                        ...
                        <form id="contactForm">
                            <div class="mb-6">
                                <div class="mx-0 mb-1 sm:mb-4">
                                    ...
                                    <div class="mx-0 mb-1 sm:mb-4">
                                        <label for="email"
                                            class="pb-1 text-xs uppercase tracking-wider"></label><input type="email"
